...
namespace Mapping_Data2
{
    class Program
    {
        //各種初期設定*************************************************************************************************
        //////CSVファイルパス//////////////////////////////////////////////////////////////////////
        private static string csv_path = @"C:\Users\SENS\source\repos\Control_PTU\Control_PTU\csv\map2test\";    //読み込み場所
        private static string LMm_file_name = "2018_11_14 154721";         //***ファイル名***
        private static int Threshold = 120;                                //***フラグの閾値***
        private static string output_path = @"C:\Users\SENS\source\repos\Control_PTU\Control_PTU\csv\map2test\Split_OP.csv";       //出力先のパス(最終配列)
        private static string output_path_y = @"C:\Users\SENS\source\repos\Control_PTU\Control_PTU\csv\map2test\Split_OP_y.csv";   //出力先のパス（測定値）
        //////同期時間の設定///////////////////////////////////////////////////////////////////////
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                string PTU_file_path = csv_path + "MP_" + temp_num2.ToString() + ".csv";        //PTUのファイルパス
